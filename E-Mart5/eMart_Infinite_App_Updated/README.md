...
## v1.9.0 — Realistic 3D / Next-Gen Experience

- Reworked the homepage hero into a layered realistic 3D presentation using real photography, depth, reflections, glass surfaces and motion.
- Added a new **Next-Gen Experience** section for Shopping, Food and Travel.
- Added floating photographic service cards, animated payment-card surface and AI smart-assist chip.
- Added a subtle site-wide 3D ambient layer with orbit/grid/light motion.
- Added animated 3D depth treatment to service-page hero imagery.
- Added image fallback handling so missing Shopping/Food/Medicine imagery falls back to a relevant real photographic asset instead of leaving blank cards.
- Added Biryani-specific fallback to the restaurant photograph.
- Retained dark mode and warm light mode with persistence in `localStorage`.
- Retained hidden browser scrollbars while normal scrolling continues to work.
- Added reduced-motion support for accessibility.
- Product/service data and existing routes are preserved.
