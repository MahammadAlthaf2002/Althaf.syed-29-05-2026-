  ...
  {supportOpen&&<div className="modalBackdrop" onMouseDown={e=>e.target===e.currentTarget&&setSupportOpen(false)}>
    <section className="supportModal" role="dialog" aria-modal="true" aria-label="Customer support">
      ...
      <div className="supportGrid">
        <button onClick={()=>nav('/service/more')}><Icon name="search"/><span><b>Help center</b><small>Browse service guides and FAQs</small></span><Icon name="arrow" size={15}/></button>
        ...
        <button onClick={()=>{setSupportOpen(false);alert('Live support is available 24/7 in the production version.')}}><Icon name="bell"/><span><b>Live support</b><small>Connect with an available agent</small></span><Icon name="arrow" size={15}/></button>
