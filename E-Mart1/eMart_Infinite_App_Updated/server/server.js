...
app.get('/api/health',(_req,res)=>res.json({ok:true,service:'eMart Infinite App API'}));
...
app.listen(PORT,()=>console.log(`eMart Infinite API running on http://localhost:${PORT}`));
